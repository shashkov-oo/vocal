...
VPT.PATTERNS = [
  { id:"1",  name:"1 трель (губами бр)",              bpm:150, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"Следите за тем, чтобы пальцы оставались на щеках. Губы должны двигаться легко и равномерно, не слишком быстро Когда губы работают быстро, они напрягаются Чувствуете, как резонансные ощущения переходят в затылочную часть головы Вы также ощущаете связанные звукоизвлечения при движении от грудного голоса к головному Думайте не о нотах, а о треле, которую делают губы Теперь ваша очередь Начинают басы Теперь теноры Теперь меццо и альто Меццо-сопрано и альто" }, //150 bpm
  { id:"2",  name:"2 трель (языком р)",               bpm:150, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"2 3:30" }, 
  { id:"3",  name:"3 трель (губами бр) скачки",       bpm:150, type:"semitone", data:[0,7,4,12,7,4,0], desc:"3 7:20" },
  { id:"4",  name:"4 трель (языком р) скачки",        bpm:150, type:"semitone", data:[0,7,4,12,7,4,0], desc:"4 10:10" },
  { id:"5",  name:"5 ней-ней-ней-ней",                bpm:120, type:"degree",   data:[1,3,5,8,8,8,8,5,3,1], desc:"5 12:52" },
  { id:"6",  name:"6 ней-ней-ней-ней",                bpm:100, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"6 15:10" },
  { id:"7",  name:"7 ма-ма-ма-ма плаксиво",           bpm:90, type:"degree",   data:[1,3,5,8,8,8,8,5,3,1], desc:"7 17:53" },
  { id:"8",  name:"8 ма-ма-ма-ма",                    bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"8 20:36" },
  { id:"9",  name:"9 о-о-о-о-о-о-о-о-о",              bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"9 23:35" },
  { id:"10", name:"10 а-а-а-ааааааааа-а-а-а-а",        bpm:90, type:"degree",   data:[ {d:1},{d:3},{d:5},{d:8, dur:"1n"},{d:5},{d:3},{d:1} ], desc:"10 e" },
  { id:"11", name:"11 и-и-и-и-и",                      bpm:90, type:"semitone", data:[0,7,4,12,7,4,0,7,4,12,7,4,0], desc:"11 d 32 min" },
  { id:"14", name:"11 и-и-и-и-и",                      bpm:90, type:"semitone", data:[0,4], desc:"у-ы" },
  { id:"15", name:"15 у-ы закрытый рот",               bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"15 35:40" },
  { id:"16", name:"16 ууу-ууу-ууу-ууу-у",               bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"15 35:40" },
  { id:"17", name:"17 хм-м-м-м закрытый рот",          bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"17 43:17" },
  { id:"18", name:"18 хм-м-м-м закрытый рот длинный пик", bpm:90, type:"semitone", data:[{d:0},{d:4},{d:7},{d:12},{d:16},{d:19, dur:"1n"},{d:17},{d:14},{d:11},{d:7},{d:5},{d:2},{d:0}], desc:"18 46:40" },
  { id:"19", name:"19 м-м-м-м закрытый рот",           bpm:90, type:"semitone", data:[0,7,4,12,7,4,0,7,4,12,7,4,0], desc:"19 50:46" },
  { id:"20", name:"20 м-м-м-м-мммммааааа-а-а-а",       bpm:90, type:"degree",   data:[ {d:1},{d:3},{d:5},{d:8, dur:"1n"},{d:5},{d:3},{d:1} ], desc:"10 e" },
  { id:"21", name:"21 о-о-о вниз/вверх, длинный пик",  bpm:90, type:"degree",   data:[{d:8},{d:5},{d:3},{d:1},{d:3},{d:5},{d:8},{d:5},{d:3},{d:1},{d:3},{d:5},{d:8, dur:"2n"},{d:5},{d:3},{d:1}], desc:"21 56:45" },
  { id:"22", name:"22 а-а-а-а",                         bpm:90, type:"semitone", data:[0,7,4,12,7,4,0,7,4,12,7,4,0], desc:"22 1:01:30" },
  { id:"23", name:"23 о-о-о-о-а?",                      bpm:90, type:"degree",   data:[{d:1},{d:3},{d:5},{d:8, dur:"1n"},{d:5},{d:3},{d:1}], desc:"23 1:02:32" },
  { id:"24", name:"24 и-и-и-иииии-ууууу-ааааа-а-а-а",  bpm:90, type:"degree",   data:[{d:1},{d:3},{d:5},{d:8, dur:"2n"},{d:8, dur:"2n"},{d:8, dur:"2n"},{d:5},{d:3},{d:1}], desc:"24 1:03:25" },
  { id:"25", name:"25 о-а колебания +- полтона",       bpm:90, type:"semitone", data:[{d:5, dur:"2n"},{d:4, dur:"2n"},{d:3, dur:"2n"},{d:2, dur:"2n"},{d:1, dur:"2n"}], desc:"25 1:04:48" },
  { id:"26", name:"26 а",                               bpm:90, type:"semitone", data:[0,4,7,12,16,19,17,14,11,7,5,2,0], desc:"26 1:05:06" }
];
